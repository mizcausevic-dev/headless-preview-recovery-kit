...
try {
    ...
    $targets = @(
        ...
        @{ Url = "http://127.0.0.1:$port/preview-matrix"; File = "02-preview-matrix-proof.png"; Size = "1600,1460" },
        @{ Url = "http://127.0.0.1:$port/recovery-rules"; File = "03-recovery-rules-proof.png"; Size = "1600,1180" },
